...
export default function App() {
  ...
  const [packagings, setPackagings] = useState<MasterPackaging[]>(() => {
    ...
    return saved ? JSON.parse(saved) : [
      { id: 'PACK01', name: 'CPR REDEA 60x40 H17', tare: 1.5, width: 600, depth: 400, height: 170 },
      { id: 'PACK02', name: 'IFCO DS 1003 BLACK LL', tare: 0.95, width: 400, depth: 300, height: 120 },
      { id: 'PACK03', name: 'Cartone 60x40 H16', tare: 0.6, width: 600, depth: 400, height: 160 },
      { id: 'PACK04', name: 'Cassetta legno 50x30 H14', tare: 1.3, width: 500, depth: 300, height: 140 }
    ];
  });
